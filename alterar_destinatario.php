...
while($n=mysql_fetch_array($sqlNome)) {
	...
	$atualizaDestinatario = mysql_query("Update destinatarios set nome = '$nome', cargo = '$cargo', orgao = '$orgao', end = '$end', cep = '$cep', cidade = '$cidade', telefone = '$tel', email = '$email' where id = '$id'");
...
echo "
			<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
				<tr>
					...
					<td valign='middle' align='center' height='60' class='vde16'>O destinatario ($tel) <b>$nome</b> foi atualizado com sucesso!<br><img src='img/branco.gif' height='5'><br><font class='cza12'><i><a href='pdf.php?id=$id_oficio_emitido' class='linkcza'>Clique aqui para abrir e imprimir</a></td>
				</tr>
			</table>";