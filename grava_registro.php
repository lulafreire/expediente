...
<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
	...
	$grava = mysql_query("insert into oficios_recebidos (num, emissor, data, assunto) values ('$num','$emissor','$ndata','$assunto')");
	$id_oficio_recebido = mysql_insert_id();
	$gravaEvento = mysql_query("insert into eventos (data, id, origem, descricao) values (curdate(),'$id_oficio_recebido','oficios_recebidos','Ofício cadastrado')");
	...
	<table width='800' cellpadding='0' cellspacing='0' class='bordasimples'>
		<tr>
			...
			<td valign='middle' align='center' height='60' width='740' class='vde16'>O Ofício nº $num de <b>$emissor</b> foi cadastrado com sucesso!<br><img src='img/branco.gif' height='5'><br><font class='cza12'><i>$msg</i></font><br></td>
		</tr>
	</table>";
		...
		if ($_UP['tamanho'] < $_FILES['arquivo']['size'] or $_FILES['arquivo']['size'] == 0) {
			...
			$grava = mysql_query("insert into oficios_recebidos (num, emissor, data, assunto, anexo, tam, descricao) values ('$num','$emissor','$ndata','$assunto','$novoNome','$tamMb','$descricao')");
			$id_oficio_recebido = mysql_insert_id();
			$gravaEvento = mysql_query("insert into eventos (data, id, origem, descricao) values (curdate(),'$id_oficio_recebido','oficios_recebidos','Ofício cadastrado')");
			...
			<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
				<tr>
					<td valign='middle' align='center' height='60' width='60' background='img/cinza.gif'><img src='img/sucesso.png'></td>
					<td valign='middle' align='center' height='60' class='vde16'>O Ofício nº $num de <b>$emissor</b> foi cadastrado com sucesso!<br><img src='img/branco.gif' height='5'><br><font class='cza12'><i>O arquivo $anexo foi anexado e renomeado para \"<a href='download.php?url=$novoNome' class='linkcza'>$novoNome</a>\" com $tamMb Mb</td>
				</tr>
			</table>";		
