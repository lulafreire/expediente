...
if($txtNome=='') {
	...
	include("frm_memos_recebidos.php");
...
<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
	<tr>
		...
		<td valign='middle' align='left' class='azul16'>&nbsp;&nbsp;<b>Memorandos Recebidos</b> <font class='cza12'><i>Cadastrar memorandos recebidos</i></font></td>
	</tr>
</table>
...
<table width='940' cellpadding='0' cellspacing='0'>
  <tr><form method="post" action="index.php?conteudo=grava_memo_recebido.php" enctype="multipart/form-data">
  ...
  <tr>
    <td valign='middle' align='right' width='200' class='azul12'><b><font class='azul12'>Interessado:&nbsp;&nbsp;</td>
  ...
  <tr>
    ...
    <td valign='middle' align='left'><? include("select_memos_emitidos.php"); ?></td>
  </tr>
  <tr>
    <td valign='middle' width='200'><hr size='1' color='#c0c0c0'></td>
    <td valign='middle'><hr size='1' color='#c0c0c0'></td>
