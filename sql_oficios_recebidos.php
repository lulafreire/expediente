...
$sqlRecebidos = mysql_query("Select * from oficios_recebidos $sqlResp");
$total_registros = mysql_num_rows($sqlRecebidos);

// Pesquisa os ofícios recebidos para realizar a paginação
$sqlRec = mysql_query("Select * from oficios_recebidos $sqlResp order by data desc LIMIT $inicio,$limite");
...
<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
	<tr>
		...
		<td width='860' valign='middle' align='left' class='azul14'>&nbsp;&nbsp;<b>$total_registros Ofícios Recebidos</b></td>
		<td width='40' height='30' valign = 'middle' align='center' class='azul10'><a title='Exibir ofícios não respondidos' href='sql_oficios_recebidos.php?respondidos=0'><img src='img/flag_ver.png' height='16'></a></td>
	</tr>
...
while($r = mysql_fetch_array($sqlRec)) {
	...
	if($anexo !='') {
		...
		$baixar_anexo = "<a title='O ofício nº $numero não foi anexado. Detalhe para ver se há outros anexos'><img src='img/pdf_cza.png' border='0'></a>";
	...
	<tr>
		...
		<td width='40' height='30' valign = 'middle' align='center' class='azul10'><a href='index.php?conteudo=detalha.php&oficioID=$id&tipo=1' title='Ver detalhes' target='_parent'><img src='img/txt.png' border='0'></a></td>
		<td width='40' height='30' valign = 'middle' align='center' class='azul10'><a href='index.php?conteudo=editar.php&oficioID=$id&tipo=1' title='Editar' target='_parent'><img src='img/edit.png' border='0'></a></td>
		<td width='40' height='30' valign = 'middle' align='center' class='azul10'><a href='index.php?conteudo=excluir.php&oficioID=$id&tipo=1' title='Excluir' target='_parent'><img src='img/delete.png' border='0'></a></td>
	</tr>";
...
<table cellpadding='0' cellspacing='0' class='bordasimples' height='35'>
	<tr>
		<td width='100' height='35' valign='middle' align='center' class='azul12'><b><a href='sql_oficios_recebidos.php?respondidos=$respondidos&pag=' class='linkazul'><< Primeira</a></b></td>";		
//paginação
...
for ($i = $inicio; $i <= $limite; $i++)
{
	...
	else 
	{
		...
		{
			echo "
			<td valign='middle' align='center' width='35' class='cza14'><a href='sql_oficios_recebidos.php?pag=$i&respondidos=$respondidos' class='linkcza'>$i</a></td>";
		}
	}
}
echo "<td width='100' valign='middle' align='center' width='35' class='azul12'><a href='sql_oficios_recebidos.php?pag=$total&respondidos=$respondidos' class='linkazul'><b>Última >></b></a></td>
	</tr>
</table>
<img src='img/branco.gif' height='10'><br>
</center>";
