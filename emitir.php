...
if($idMod!='') {
	...
	$descricao = "Criar, cadastrar e imprimir novo ofício";
	$icone     = "editar.png";
...
<table width='940' cellpadding='0' cellspacing='0' class='bordasimples'>
	<tr>
		...
		<td valign='middle' align='left' class='azul16'>&nbsp;&nbsp;<b>Emitir Ofício</b> <font class='cza12'><i>$descricao</i></font></td>
	</tr>
</table>
...
<table width='940' cellpadding='0' cellspacing='0'>
  <tr><form method='post' action='index.php?conteudo=grava_oficio.php'>
  ...
  <tr>
    ...
    <td valign='middle' align='left'><? include("select_oficios_recebidos.php"); ?></td>
  </tr>
  <tr>
    <td valign='middle' width='200'><hr size='1' color='#c0c0c0'></td>
    <td valign='middle'><hr size='1' color='#c0c0c0'></td>
