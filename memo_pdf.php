...
$sqlOficio =mysql_query("Select * from memos_emitidos where id ='$id'");
...
$end_final   =  "Memorando nº $numero/$ano.pdf";
...
$pdf->Cell(190,8,"Memorando nº $numero/$ano/APSIRECE/INSS", 0, 1);
...
$pdf->SetFont('Arial','',11);
$pdf->Cell(25,8,"Interessado: ", 0, 0, 'L');
$pdf->SetFont('Arial','B',11);
$pdf->Cell(165,8,"$interessado ", 0, 1, 'L');
$pdf->Ln(10);
$pdf->SetFont('Arial','',11);
